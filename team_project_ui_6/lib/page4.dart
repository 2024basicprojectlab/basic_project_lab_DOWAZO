  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: SingleChildScrollView( // 이미지 목록을 보여주는 위젯 호출
          child: ImageList(),
        ),
        floatingActionButton: FloatingActionButton( // 우측 하단의 +동그라미 버튼
          onPressed: () {
            // 버튼을 눌렀을 때의 동작 추가
            // 새글 추가 동작 등을 여기에 구현
          },
      ...
      children: imageUrls.map((imageUrl) {
        return Container(
          ...
          decoration: BoxDecoration(
            border: Border.all(color: Colors.grey.shade300, width: 1.0), // 테두리 두께와 색상 설정
